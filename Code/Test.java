public class Test {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(ANSI_RESET + "\n  Back to default.\n");
    System.out.println("\u001B[32mTest" + ANSI_RESET);
  }
 ...
 * someSortingMethodWhichYouWantToProfile();
 * long usedMemoryAfter = Runtime.getRuntime().totalMemory() -
 * Runtime.getRuntime().freeMemory();
 * System.out.println("Espace total utilisé: " + (usedMemoryAfter -
 * usedMemoryBefore) + " octets.");
 * }
 */
